...
# My Parameters
tf.app.flags.DEFINE_string("eeg_train_data", "../eeg/train_list.txt", "Point to directory of input data")
#tf.app.flags.DEFINE_string("eeg_train_data", "../eeg/test_list.txt", "Point to directory of input data")

tf.app.flags.DEFINE_string("eeg_eval_data", "../eeg/eval_list.txt", "Point to directory of input data")

tf.app.flags.DEFINE_string("eeg_test_data", "../eeg/test_list.txt", "Point to directory of input data")
#tf.app.flags.DEFINE_string("eeg_test_data", "../eeg/train_list.txt", "Point to directory of input data")
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        out_file_path_Nd = os.path.join(out_dir, 'shhs_test.pkl')
