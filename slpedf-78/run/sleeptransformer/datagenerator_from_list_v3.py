...
class DataGenerator3:
    ...
    def next_batch(self, batch_size):
        ...
        batch_x2 = np.ndarray(
            [batch_size, self.seq_len, self.data_shape_2[0], self.data_shape_2[1], self.data_shape_2[2]])
    ...
    def rest_batch(self, batch_size):
        ...
        batch_x2 = np.ndarray(
            [actual_len, self.seq_len, self.data_shape_2[0], self.data_shape_2[1], self.data_shape_2[2]])
