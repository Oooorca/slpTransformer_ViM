...
class SleepTransformer(object):
    ...
    def __init__(self, config):
        ...
        #self.seq_trans_out = seq_trans_out
        ...
        self.accuracy = []
        #self.y_actual = []  # Initialize the list to store true labels
        ...
        with tf.name_scope("accuracy"):
            for i in range(self.config.epoch_seq_len):
                ...
                #self.y_actual.append(tf.argmax(self.input_y[:, i, :], 1))  # Save the true labels for each time index
