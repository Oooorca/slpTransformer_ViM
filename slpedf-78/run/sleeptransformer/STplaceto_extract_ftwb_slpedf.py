...
# My Parameters
tf.app.flags.DEFINE_string("eeg_train_data", "../placebo_list/sctrain_list.txt", "Point to directory of input data")

tf.app.flags.DEFINE_string("eeg_eval_data", "../placebo_list/eval_list.txt", "Point to directory of input data")

tf.app.flags.DEFINE_string("eeg_test_data", "../placebo_list/train_list.txt", "Point to directory of input data")
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        hdf5storage.savemat(os.path.join(out_path, "placebo_ret.mat"),
                            {'yhat': test_yhat,
                             'acc': test_acc,
                             'score': test_score,
        ...
        out_file_path_Nd = os.path.join(out_dir, 'st_placebo.pkl')
