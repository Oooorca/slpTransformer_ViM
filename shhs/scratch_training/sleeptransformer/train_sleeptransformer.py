...
# My Parameters
tf.compat.v1.flags.DEFINE_string("eeg_train_data", "../train_data.mat", "Point to directory of input data")
tf.compat.v1.flags.DEFINE_string("eeg_eval_data", "../data/eval_data_1.mat", "Point to directory of input data")
tf.compat.v1.flags.DEFINE_string("eeg_test_data", "../test_data.mat", "Point to directory of input data")
tf.compat.v1.flags.DEFINE_string("eog_train_data", "../train_data.mat", "Point to directory of input data")
tf.compat.v1.flags.DEFINE_string("eog_eval_data", "../data/eval_data_1.mat", "Point to directory of input data")
tf.compat.v1.flags.DEFINE_string("eog_test_data", "../test_data.mat", "Point to directory of input data")
tf.compat.v1.flags.DEFINE_string("emg_train_data", "../train_data.mat", "Point to directory of input data")
tf.compat.v1.flags.DEFINE_string("emg_eval_data", "../data/eval_data_1.mat", "Point to directory of input data")
tf.compat.v1.flags.DEFINE_string("emg_test_data", "../test_data.mat", "Point to directory of input data")
...
tf.compat.v1.flags.DEFINE_integer("seq_len", 20, "Sequence length (default: 10)")

tf.compat.v1.flags.DEFINE_integer("num_blocks", 0, "Number of transformer block (default: 0)") # if zero, specific parameters are expected for the numbers of frame blocks and seq blocks
tf.compat.v1.flags.DEFINE_integer("frm_num_blocks", 1, "Number of transformer block (default: 0)")
tf.compat.v1.flags.DEFINE_integer("seq_num_blocks", 1, "Number of transformer block (default: 0)")
tf.compat.v1.flags.DEFINE_float("frm_fc_dropout", 0.1, "Dropout keep probability (default: 0.1)")
tf.compat.v1.flags.DEFINE_float("frm_attention_dropout", 0.1, "Dropout keep probability (default: 0.1)")
tf.compat.v1.flags.DEFINE_float("seq_fc_dropout", 0.1, "Dropout keep probability (default: 0.1)")
tf.compat.v1.flags.DEFINE_float("seq_attention_dropout", 0.1, "Dropout keep probability (default: 0.1)")
tf.compat.v1.flags.DEFINE_float("fc_dropout", 0.1, "Dropout keep probability (default: 0.1)")

# flag for early stopping
tf.compat.v1.flags.DEFINE_boolean("early_stopping", False, "whether to apply early stopping (default: False)")
